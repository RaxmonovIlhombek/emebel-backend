    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('amount', models.DecimalField(decimal_places=2, help_text="Tiyin (100 so'm = 10000 tiyin)", max_digits=16)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['send_at'],
                'indexes': [models.Index(fields=['sent', 'send_at'], name='telegram_bo_sent_c9fbc7_idx')],
            },
        ),
    ]
